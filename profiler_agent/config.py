...
class ProfilerConfiguration:
    ...
    nim_classifier_model: str = os.getenv("NIM_CLASSIFIER_MODEL", "meta/llama-3.1-8b-instruct")
    nim_analyzer_model: str = os.getenv("NIM_ANALYZER_MODEL", "meta/llama-3.1-8b-instruct")
